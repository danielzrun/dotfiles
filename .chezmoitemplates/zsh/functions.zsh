...
# Yazi - terminal file manager with shell wrapper for cd on quit
function y() {
...
# Usage: ccs [zhipu|ark|default]
function ccs() {
	local env_file="$HOME/.ccs_env"
	local provider="${1:-}"
	local valid_providers=("zhipu" "ark" "default")
